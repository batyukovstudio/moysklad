...
class CustomerOrderAttributeClient extends EntityClientBase
{
    use
    ...
    {
        parent::__construct($api, '/entity/customerorder/metadata/attributes/');
    }
    ...
    {
        return CustomerOrderAttribute::class;
    }
}
